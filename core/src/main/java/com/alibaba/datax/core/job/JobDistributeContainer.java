...
import com.alibaba.datax.core.job.scheduler.processinner.DistributeScheduler;
 ...
 *
 */
public class JobDistributeContainer extends AbstractContainer {
	private static final Logger LOG = LoggerFactory.getLogger(JobDistributeContainer.class);
	...
	public JobDistributeContainer(Configuration configuration) {
		super(configuration);
	...
	private void preHandle() {
		...
		if (StringUtils.isEmpty(handlerPluginTypeStr)) {
			return;
		}
	...
	private AbstractScheduler initScheduler(Configuration configuration) {
