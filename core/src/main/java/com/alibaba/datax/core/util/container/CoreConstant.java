...
public class CoreConstant {
	private static final Logger log = LoggerFactory.getLogger(CoreConstant.class);
...
//			new String[] { DATAX_HOME, "local_storage", "plugin","writer" }, File.separator);
	...
	public static String DATAX_HOME = null;
	public static String DATAX_CONF_PATH = null;

	public static String DATAX_CONF_LOG_PATH = null;

	public static String DATAX_SECRET_PATH = null;

	public static String DATAX_PLUGIN_HOME = null;

	public static String DATAX_PLUGIN_READER_HOME = null;

	public static String DATAX_PLUGIN_WRITER_HOME = null;

	public static String DATAX_BIN_HOME = null;

	public static String DATAX_JOB_HOME = null;

	public static String DATAX_STORAGE_TRANSFORMER_HOME = null;

	public static String DATAX_STORAGE_PLUGIN_READ_HOME = null;

	public static String DATAX_STORAGE_PLUGIN_WRITER_HOME = null;

	static {

		try {
			DATAX_HOME = Paths.get(Thread.currentThread().getClass().getResource("/").toURI()).toString();

			DATAX_CONF_PATH = Paths.get(DATAX_HOME, "conf", "core.json").toString();

			DATAX_CONF_LOG_PATH = Paths.get(DATAX_HOME, "conf", "logback.xml").toString();

			DATAX_SECRET_PATH = Paths.get(DATAX_HOME, "conf", ".secret.properties").toString();

			DATAX_PLUGIN_HOME = Paths.get(DATAX_HOME, "plugin").toString();

			DATAX_PLUGIN_READER_HOME = Paths.get(DATAX_HOME, "plugin", "reader").toString();

			DATAX_PLUGIN_WRITER_HOME = Paths.get(DATAX_HOME, "plugin", "writer").toString();

			DATAX_BIN_HOME = Paths.get(DATAX_HOME, "bin").toString();

			DATAX_JOB_HOME = Paths.get(DATAX_HOME, "job").toString();

			DATAX_STORAGE_TRANSFORMER_HOME = Paths.get(DATAX_HOME, "local_storage", "transformer").toString();

			DATAX_STORAGE_PLUGIN_READ_HOME = Paths.get(DATAX_HOME, "local_storage", "plugin", "reader").toString();

			DATAX_STORAGE_PLUGIN_WRITER_HOME = Paths.get(DATAX_HOME, "local_storage", "plugin", "writer").toString();
		} catch (URISyntaxException e) {
			log.error("Failed to init static data.", e);
		}
	}
}
